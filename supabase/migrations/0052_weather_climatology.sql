...
COMMENT ON TABLE public.weather_climatology IS 'Phase 14: 366-row per-DoY weather normals from 4-5 years of Berlin history. Used as Tier 3 fallback in exog cascade.';
