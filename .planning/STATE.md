...
| Phase 07-column-promotion P04 | 15min | 2 tasks | 9 files |
...
- [Phase 07-column-promotion]: 07-04: CountryMultiSelect bypasses generic MultiSelectDropdown (wrap-not-extend); Svelte 5 bindable props tested via onSelectionChange spy not component.selected; country serializer skips full-set collapse rule because meta-sentinels make 'select all' meaningless
