...
| 260420-wdf | Day-of-week filter (7 checkboxes, Mon..Sun) applied client-side to KPI tiles + calendar cards + heatmap dim; retired Lin/Log interpolation toggle (locked to log-linear); cohort/LTV cards show caveat banner when days != all-7. Chrome MCP QA + SQL cross-check caught per-item cards missing DOW filter — fix in 7027b4b | 2026-04-20 | 03db100, 1c9cf3a, 7027b4b | [260420-wdf-dow-filter-retire-lin-log](./quick/260420-wdf-dow-filter-retire-lin-log/) |
