...
Plans:
  ...
  - [ ] 09-04-PLAN.md — Gap closure: reactive filters state in dashboardStore — fix UAT Tests 7/9 (stale FilterBar labels/aria-checked after replaceState)
**UI hint**: yes
...
| 9. Filter Simplification & Performance | v1.2 | 3/4 | In progress | - |
